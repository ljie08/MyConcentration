...
- (void)showBarView {
    ...
    for (int i = 0; i < count; i++) {
        ...
        numLab.text = [NSString stringWithFormat:@"%@%@", self.numLabels[i], NSLocalizedString(@"ci", nil)];
        numLab.font = [UIFont systemFontOfSize:13];
        numLab.textColor = FontColor;
